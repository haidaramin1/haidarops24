...
So after getting the skeleton from the galaxy role command, I started taking all the relevant playbooks from before and putting it in their respective places manually. I got some errrors here where I had to adjust some of the playbooks from before, I think it was because of indentation but I changed it nontheless. 
