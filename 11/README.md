...
So first we make a playbook and referencing to the document of Playbook loops and followed the instructions there.
...
For now you can create empty files in the `files/` directory called anything as long as the suffix is `.md`:
 ...
 Here I followed fileglob lookup guide. We choose all *.md MD files what we want to copy.
...
* [loops](https://docs.ansible.com/ansible/latest/playbogather_facts: falseok_guide/playbooks_loops.html)
* [ansible.builtin.user](https://docs.ansible.com/ansible/latest/gather_facts: falsecollections/ansible/builtin/user_module.html)
