...
So just as the Ansible docs says It "Print statements during execution"
...
So Ansible_facts is like a dictionary within Ansible, and when you run your server it gathers their hardware and software informations, and the results is saved in ansible_facts. 
...
We just change the state from present to absent. 
